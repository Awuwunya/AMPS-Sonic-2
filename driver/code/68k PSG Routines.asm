...
dUpdateFreqPSG3:
		...
		moveq	#ctPSG3,d0		; load PSG3 type value instead
...
; ---------------------------------------------------------------------------
		...
		move.b	d0,dPSG.l		; write frequency low nibble and latch channel
		move.b	d6,dPSG.l		; write frequency high nibbles to PSG
...
.nocap
		...
		move.b	d5,dPSG.l		; write volume command to PSG port
...
dMutePSGsfx:
		...
		move.b	d0,dPSG.l		; write volume command to PSG port
