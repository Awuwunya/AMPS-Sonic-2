...
dNoteWriteDAC2:
		lea	dZ80+PCM2_Sample.l,a1	; load addresses for PCM 1
		lea	dZ80+PCM2_NewRET.l,a2	; ''
		bra.s	dNoteOnDAC4

dNoteWriteDAC1:

		lea	dZ80+PCM1_Sample.l,a1	; load addresses for PCM 2
		lea	dZ80+PCM1_NewRET.l,a2	; ''
...
dUpdateFreqDAC3:
	...
	StopZ80					; wait for Z80 to stop
		move.b	d6,dZ80+PCM2_PitchHigh+1.l
		move.b	d0,dZ80+PCM2_PitchLow+1.l
...
dFreqDAC1:
	StopZ80					; wait for Z80 to stop
		move.b	d6,dZ80+PCM1_PitchHigh+1.l
		move.b	d0,dZ80+PCM1_PitchLow+1.l
...
dUpdateVolDAC:
		...
		moveq	#$80,d5			; force volume to mute ($80 is the last valid volume)
...
dUpdateVolDAC2:
	...
	StopZ80					; wait for Z80 to stop
		...
		move.b	d5,dZ80+PCM2_Volume+1.l	; save volume for PCM 1
	StartZ80				; enable Z80 execution
		rts

.dac1
		move.b	d5,dZ80+PCM1_Volume+1.l	; save volume for PCM 2
	StartZ80				; enable Z80 execution
